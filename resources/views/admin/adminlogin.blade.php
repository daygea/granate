...
<head>
    ...
    <title>Admin Panel - Granate Realty</title>
    ...
    <div class="columns fulllogin is-centered">
        <div class="column is-two-thirds leftsideeffect">
            ...
            <div class="is-mobile textboxlogin">
                ...
                <p class="subtitle  has-text-centered is-size-7 tinytextlogin">Enter your email and password to login into
                    your admin panel.</p>
            </div>
            <div class="loginform">
...
<div class="is-mobile is-centered has-text-centered textboxlogin">
    ...
    <p class="subtitle  has-text-centered is-6">Enter your email and password to login your account to enjoy the great services.
