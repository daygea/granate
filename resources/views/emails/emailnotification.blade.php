...
<p>This is inform you that following property ad you posted on the site has been <b>{{$message->status}}</b> by the Administrator of Granate Realty Limited</p>
...
@component('mail::button', ['url' => 'mailto:daygeacardury@gmail.com'])
Reply Message
@endcomponent
