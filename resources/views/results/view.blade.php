...
<head>
    ...
    <title>Granate Realty - Redefining the Real Estate Business</title>
    ...
    <div class="viewsection">
        ...
        <div class="containerx detailssection">
            ...
            <div class="column is-flex-mobile">
                ...
                <p>
                    House 1 - (8,500 sq ft including terraces) 90 perches - N170m / $3,500pm
                    <br>
                    ...
                    gardens
                    <br>
                    <br> House 2 (5,000 sqft including terraces) - 32 perches - N80m /$1,500pm
            ...
            <div class="column is-flex-mobile" id="contactbox">
                ...
                <div class="notification is-danger">
                    ...
                    <strong>Important information:</strong> This ad has been posted on Granate Realty by the above mentioned
                    advertiser. Granate Realty does not have any connection with this advertiser, nor do we vet the advertisers,
                    guarantee their services, responsible for the accuracy of the ad's content or are responsible for services
                    provided by the advertisers. Granate Realty does not provide any service other than list the advertisements
                    ...
                    contact of the payment receiver.
                </div>
