...
<head>
    ...
    <title>About Us - Granate Realty</title>
...
<body>
    ...
    <div class="columns is-mobile is-centered has-background-white">
        <div class="container has-text-centered aboutus has-text-dark">
            ...
            <br>
            <p>Welcome to Granate Realty Limited, your number one source for all things real estate. We're dedicated to giving you the very best of real estate, with a focus on fast, trust, efficient.
                <br>
                <br>
                <p>Granate Realty has come a long way from its beginnings. When we first started out, our passion for fast and trustworthiness drove us to do tons of search so that we can offer you the world's most advanced real state search engine. We now serve customers all over the world, and are thrilled that we're able to turn our passion into our own website.</p>
                <br>
                ...
                <br>
                <p><i><b>Granate Realty Limited</b></i></p>
        </div>
    </div>
